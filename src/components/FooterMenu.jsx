...
import LuxspaceLogo from '../assets/logo.svg'
  ...
  return (
    ...
    <div className="border-t border-b border-gray-200 py-12 mt-16 px-4">
      <div className="flex justify-center mb-8">
        <img src={LuxspaceLogo} alt="Logo LuxSpace" />
      </div>
      <aside className="container mx-auto">
        <div className="flex flex-wrap md:space-x-4 justify-center">
          ...
          <div className="w-full md:w-2/12 mb-4 md:mb-0 accordion">
            ...
            <ul className="h-0 md:h-auto md:visible overflow-hidden">
              <li>
          ...
          <div className="w-full md:w-2/12 mb-4 md:mb-0 accordion">
            ...
            <ul className="h-0 md:h-auto md:visible overflow-hidden">
              ...
              <li>
                <a href="#" className="hover:underline py-1 block">Carrer</a>
              </li>
              <li>
                <a href="#" className="hover:underline py-1 block">About us</a>
              </li>
            </ul>
          </div>
