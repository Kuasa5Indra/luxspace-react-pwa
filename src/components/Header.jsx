            ...
            opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100">
                    ...
                    <div className="w-auto">
                        <ul className="flex items-center">
                            ...
                            <li className="ml-6">
                                <Link to='/cart' id="header-cart" className={`flex items-center justify-center w-8 h-8 text-black ${mode === 'main' ? 'hover:text-white' : ''} cart cart-filled`}>
                                    <svg className="fill-current" width="29" height="25" viewBox="0 0 29 25" fill="none"
                                        ...
                                        {cart && cart.length > 0 && (
                                            <g className="text-pink-400">
                                                <circle cx="25" cy="4.89023" r="4" className="fill-current dot" />
                                            </g>
                                        )}
                                    </svg>
                                </Link>
