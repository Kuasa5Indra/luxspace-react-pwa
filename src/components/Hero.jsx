...
import ImageHero from '../assets/contents/image-hero.jpeg';
  ...
  return (
    ...
    <div
      ...
      <h2 className="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
        Kami menyediakan furniture berkelas yang <br className="hidden lg:block" /> membuat ruangan terasa homey
      </h2>
      <div>
    ...
    <div className="w-full inset-0 md:relative md:w-1/2">
      <div className="relative hero-image">
        ...
        <div className="overlay right-0 bottom-0 md:inset-0">
          <button className="video hero-cta focus:outline-none z-30 modal-trigger" onClick={handleShowModal}>
          </button>
        </div>
        <img className="absolute inset-0 md:relative w-full h-full object-cover object-center"
          src={ImageHero} alt="House with sofa and some plants" />
      </div>
    </div>
